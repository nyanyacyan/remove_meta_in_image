...
from method.errorHandlers import AccessFileNotFoundError
...
class BaseToPath:
    ...
    def toLogsPath(self, levelsUp: int = 3, subDirName: str = "logs"):
    ...
    def getPickleFilePath(
        self, pklName: str, levelsUp: int = 2, subDirName: str = "pickles"
    ):
    ...
    def getResultOutputPath(self, levelsUp: int = 3, dirName: str = Dir.result.value):
