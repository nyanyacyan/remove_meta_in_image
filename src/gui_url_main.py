...
if __name__ == "__main__":
    ...
    window = GuiUrlMain(window_title=window_title, position_x=position_x, explain=explain, position_y=position_y, size_x=size_x, size_y=size_y)
    window.show()
    sys.exit(app.exec())
